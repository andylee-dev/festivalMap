					...
					<% } %>
						...
						<div class="container col-6">
							...
							<form action="/signUp" method="post">
								<input type="hidden" name="status" value="1"> <input type="hidden" name="big_code"
									value="1"> <input type="hidden" name="small_code" value="2"> <input type="hidden"
									name="point" value="0"> <input type="hidden" name="file_name" value="">
								...
								<div class="container row justify-content-center my-5">
									<button type="submit" class="btn btn-primary col-5 px-3 mx-2"
										...
										onclick="submitForm(event);">저장하기</button>									<button type="reset" class="btn btn-primary col-5 px-3 mx-2"
