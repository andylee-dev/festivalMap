	...
	<div class="container-fluid">
		...
		<main class="col-10 p-0">
			...
			<div class="container my-5" id="detail-body-container">
				...
				<div>
				<h3 style="color: #FF4379 ">공통코드정보 수정</h3>
				</div>
				<div class="my-5">
					...
					<div class="container p-5" id="form-container">
						<form action="commonCodeUpdate" method="post">
							<div class="mb-3 ">
							  ...
							  <input type="number" class="form-control" value="${commonCode.big_code}" disabled>
							  <input type="hidden" class="form-control" name="big_code" id="big_code" required="required" value="${commonCode.big_code}">
							</div>
							<div class="mb-3 ">
							  <label for="samll_code" class="form-label">소분류</label>
							  <input type="number" class="form-control" value="${commonCode.small_code}" disabled>
							  <input type="hidden" class="form-control" name="samll_code" id="samll_code" required="required" value="${commonCode.small_code}">
							</div>
							<div class="mb-3 ">
							  <label for="content" class="form-label">내용</label>
							  <input type="text" class="form-control" name="content" id="content" required="required" value="${commonCode.content}">
							</div>
