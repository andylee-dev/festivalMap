				...
				<main class="col-10 overflow-auto p-0">
					...
					<div class="admin-header-container">
						<div class="container m-4">
							...
							<label  class="admin-header-title ">지역코드 정보 등록 </label>					
						</div>
					</div>	
					
					<!-- Section2: Table -->		
					<div class="border p-3 m-3">
						<form action="areaCode/insert" method="post">
							<table class="table table-striped table-sm">
								<tr>
									<th>대분류</th>
									<td><input type="number" name="area" required="required"></td>	
								</tr>
								<tr>
									<th>소분류</th>
									<td><input type="number" name="sigungu" required="required"></td>
								</tr>
								<tr>
									<th>내용</th>
