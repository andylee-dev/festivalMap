	...
	<div class="container-fluid">
		...
		<main class="col-10 p-0">
			...
			<div class="container my-5" id="detail-body-container">
				...
				<div>
				<h3 style="color: #FF4379 ">지역코드정보 등록</h3>
				</div>
				<div class="my-5">
				<div class="" id="detail-main-container">
					<div class="container p-5" id="form-container">
						<form action="commonCodeInsert" method="post">
							<div class="mb-3 ">
							  <label for="area" class="form-label">대분류</label>
							  <input type="number" class="form-control" name="area" id="area" required="required">
							</div>
							<div class="mb-3 ">
							  <label for="sigungu" class="form-label">소분류</label>
							  <input type="text" class="form-control" name="sigungu" id="sigungu" required="required">
							</div>
							<div class="mb-3 ">
