	...
	<div class="container-fluid">
		...
		<main class="col-10 p-0">
			<div class="admin-header-container">
				...
				<label  class="admin-header-title ">지역코드관리</label>	
				</div>
			</div>
			...
			<div class="container my-5" id="detail-body-container">
				...
				<div>
				<h3 style="color: #FF4379 ">지역코드정보 수정</h3>
				</div>
				<div class="my-5">
					...
					<div class="container p-5" id="form-container">
						<form action="commonCodeUpdate" method="post">
							<div class="mb-3 ">
							  ...
							  <input type="number" class="form-control" value="${areaCode.area}" disabled>
							  <input type="hidden" class="form-control" name="area" id="area" required="required" value="${areaCode.area}">
							</div>
							<div class="mb-3 ">
							  <label for="samll_code" class="form-label">소분류</label>
							  <input type="number" class="form-control" value="${areaCode.sigungu}" disabled>
							  <input type="hidden" class="form-control" name="sigungu" id="sigungu" required="required" value="${areaCode.sigungu}">
							</div>
							<div class="mb-3 ">
							  <label for="content" class="form-label">내용</label>
							  <input type="text" class="form-control" name="content" id="content" required="required" value="${areaCode.content}">
							</div>
							...
							<div class="d-flex justify-content-between">
		                        ...
		                        <div class="col-2 mb-3">
		                        	<button type="button" class="btn btn-outline-secondary w-100" onclick="location.href='../admin/areaCode'">취소</button>
		                        </div>
							</div>							
