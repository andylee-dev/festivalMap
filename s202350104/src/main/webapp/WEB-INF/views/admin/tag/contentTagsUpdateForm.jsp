						...
						<div class="" id="detail-main-container">
							<div class="container p-5 mx-3" id="form-container">
								<div class="form-row d-flex justify-content-between">
									<div class="col-md-11 mb-3 px-2">
										...
										<input type="text" class="form-control form-input" id="contentId"
										 name="id" value="${contents.id}" disabled>
									</div>
								</div>
								<div class="form-row d-flex justify-content-between">
									<div class="col-md-11 mb-3 px-2">
										...
										<input type="text" class="form-control form-input" id="title"
										 name="title" value="${contents.title}" disabled>
									</div>
								</div>
								<div class="form-row d-flex justify-content-between">
									<div class="col-md-11 mb-3 px-2">
										<label for="group_name" class="form-label">태그추가</label>
								...
								<div align="center" class="mt-3">
									...
									<button type="button" class="btn btn-outline-secondary" onclick="location.href='<%=request.getContextPath()%>/admin/tag/contentTag'">목록</button>
								</div>
							</div>
						</div>
					</div>
