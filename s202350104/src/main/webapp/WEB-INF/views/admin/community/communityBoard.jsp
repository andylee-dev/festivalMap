		...
		<div class="row">
			...
			<main class="col-10 overflow-auto p-0">
				...
				<div class="container col-9 justify-content-center mt-5">
					<c:choose>
						<c:when test="${smallCode eq 2}">
							<form action="magazin" method="POST" class="container justify-content-center">	
						...
						<c:when test="${smallCode eq 3}">
							<form action="board" method="POST" class="container justify-content-center">	
								<div class="col-12 my-4 d-flex align-items-center">
									<label for="searchType" class="col-form-label col-2  mx-2">검색어</label>
									<div class="col-4">
										<select name="search" class="form-select">
						...
						<c:when test="${smallCode eq 6}">
							<form action="review" method="POST" class="container justify-content-center">	
								<div class="col-12 my-4 d-flex align-items-center">
									<label for="searchType" class="col-form-label col-2  mx-2">검색어</label>
									<div class="col-4">
										<select name="search" class="form-select">
