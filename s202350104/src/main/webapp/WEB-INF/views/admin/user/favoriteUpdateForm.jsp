				...
				<div class="admin-header-container">
					<div class="container m-4">
						<i class="title-bi bi bi-people-fill "></i> <label
							class="admin-header-title ">일반 회원( ${favoriteDetail.name} )</label>
					</div>
				</div>
					...
					<div class="my-5">
						<div class="" id="detail-main-container">
							<div class="container d-flex justify-content-around" id="detail-top-container">
								...
								<label id="detail-top-id" >${favoriteDetail.user_id}</label>
							</div>
							<div class="container p-5 mx-3" id="form-container">
							    <form action="/admin/user/favoriteUpdate" method="POST">
							    	<input type="hidden" name="user_id" value="${favoriteDetail.user_id}">
