				...
				<div class="border p-3 m-3">
					<form action="restaurant/insert" method="post">
						<table class="table table-striped table-sm">
							...
							<tr><th>영업시간</th><td><input 	type="text" 	name="open_time" 	required="required"></td></tr>
							<tr><th>휴무일</th><td><input 	type="text" 	name="rest_date" 	required="required"></td></tr>
						...
						<div align="center">
							<button type="button" class="btn btn-outline-secondary" onclick="return confirm('등록하시겠습니까?')">등록</button>
