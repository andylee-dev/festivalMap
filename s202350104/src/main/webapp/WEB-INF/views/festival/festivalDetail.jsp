	...
	<body>
		...
		<div class="container border p-5">
		    <div class="text-right"> <!-- 버튼을 오른쪽 정렬하는 부분 -->
		        <button class="btn btn-primary" onclick="location.href='../boardInsertForm?userId=${userId}&bigCode=${bigCode}&smallCode=${smallCode}&contentId=${festival.content_id}'">글쓰기</button>
		    </div>
			<table class="table">
