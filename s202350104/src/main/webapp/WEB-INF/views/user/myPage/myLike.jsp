		...
		<div class="d-flex">
			...
			<div class="container p-5 col-10">
				<div class="container my-5">
					...
					<div
						class="container col-9 justify-content-center align-items-center mb-2 p-3 pt-0">
									...
									<tbody>
										...
										<c:forEach var="myLikeList" items="${myLikeList}">
											<tr>
												...
												<td><fmt:formatDate value="${myLikeList.create_at}"
														type="date" pattern="YY/MM/dd" /></td>
												<td><button type="button" class="btn btn-primary"
														onclick="deleteConfirm(${myLikeList.content_id})">취소</button></td>
											</tr>
					...
					<ul class="pagination justify-content-center">
						...
						<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
							<li class="page-item"><a class="page-link"
								href="myLike?&currentPage=${i}" class="pageblock">${i}</a></li>
						</c:forEach>
