...
<body>
	...
	<div class="container homeCommon-keyword-title-custom">
		...
		<div class="co1 text-div">
			<h4><strong>어느 체험로 떠나볼까요~♫</strong></h4>
		</div>
	</div>
		...
		<div class="row row-cols-3">
			...
			<div class="col homeDetail-basic-sideImg-custom">
				<div class="row row-cols-1">
					...
					<div class="col sideImg-custom">
						<img alt="${experience.img3}" src="${experience.img3}">					
					</div>
					<div class="col sideImg-custom">
						<img alt="${experience.img3}" src="${experience.img3}">					
					</div>
			...
			<div class="col homeDetail-basic-text-custom">
				<div class="row row-cols-1">
					...
					<div class="col text-custom">
						...
						<c:choose>
							<c:when test="${experience.cost == '무료' || experience.cost == null}">
								<span>무료</span>
							</c:when>
							<c:otherwise>
								<span>유료</span>			
					...
					<div class="col text-custom">
						<img alt="icon.jpg" src="../image/boardStatus1.png">
						<p class="text-md-custom">체험시간</p>
						<p>${experience.open_time}</p>
					</div>
					<div class="col text-custom">
						<img alt="icon.jpg" src="../image/boardStatus1.png">
						<p class="text-md-custom">휴무일</p>
						<p>${experience.rest_time}</p>
					</div>
					<div class="col text-custom">
						<img alt="icon.jpg" src="../image/boardStatus1.png">
					...
					<div class="col text-custom">
						...
						<p>홈페이지</p>	
						<span>
							<a href="${experience.homepage}">${experience.homepage}</a>
						</span>										
					</div>
					<div class="col text-icon-custom">
						<div class="row row-cols-6">
							...
							<div class="row row-cols-2 icon-custom">
								<c:choose>
									<c:when test="${experience.is_stroller eq 1 }">
	...
	<div class="container homeDetail-overView_custom">
		<div class="homeDetail-overView-detail">
			...
			<p>내   용 : ${experience.inform}</p>
			<c:choose>
				<c:when test="${experience.cost == '무료' || experience.cost == null}">
				</c:when>
				<c:otherwise>
					<p>입장료 상세정보 : ${experience.cost}</p>				
				</c:otherwise>
			</c:choose>
		</div>
	</div>
			...
			<div class="col dashboardBox-custom">
				<div class="row first-box" style="">
					<div class="col col-sm-8">
						...
						<span class="common-span">★★★★★</span>으로 평가한 체험에요.</span>
					</div>
				</div>				
		...
		<div class="row row-cols-3 g-6 homeList-mdMenu-custom">
			<div class="col d-flex justify-content-center">
				<div class="card homeList-card-custom">
					...
					<div class="card-body">
						<p class="card-text title-p">체험 제목</p>
